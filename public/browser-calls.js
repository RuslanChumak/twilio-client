...
var callCustomerButtons = $(".call-customer-button");
 ...
 callSupportButton.onclick = this.callSupport
...
$(document).ready(function() {
  $.post("https://hidden-wildwood-02655.herokuapp.com/token/generate", {page: window.location.pathname}, function(data) {
...
function callSupport() {
  ...
  Twilio.Device.connect({phoneNumber: document.getElementById('phoneNumber').value});
}
